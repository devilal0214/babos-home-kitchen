          ...
          {filteredItems.map((item) => {
            ...
            return (
              <div key={item.id} className="bg-white rounded-2xl border border-stone-100 overflow-hidden group flex flex-col hover:border-orange-200 transition-colors">
                  ...
                  <div className={`absolute top-3 left-3 w-3.5 h-3.5 rounded-full border-2 border-white shadow-md ${item.dietary === 'Veg' ? 'bg-green-500' : 'bg-red-500'}`} title={item.dietary} />
