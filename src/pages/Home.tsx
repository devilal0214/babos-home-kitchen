              ...
              return (
                <div key={i} className="bg-white rounded-2xl overflow-hidden border border-stone-100 group flex flex-col">
                  <div className="aspect-[4/3] overflow-hidden relative">
                    ...
                    <img src={dish.dietary === 'Veg' ? '/uploads/gallery/Veg.svg' : '/uploads/gallery/Non_Veg_.svg'} alt={dish.dietary} title={dish.dietary} className="absolute top-3 left-3 w-6 h-6 drop-shadow" />
